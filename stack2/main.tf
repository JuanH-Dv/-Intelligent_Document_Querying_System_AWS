...
module "bedrock_kb" {
  ...
  aurora_arn        = "arn:aws:rds:us-east-1:522529622052:cluster:my-aurora-serverless"
  aurora_db_name    = "myapp"
  aurora_endpoint   = "my-aurora-serverless.cluster-clh5rswoiqdn.us-east-1.rds.amazonaws.com"
  ...
  aurora_secret_arn = "arn:aws:secretsmanager:us-east-1:522529622052:secret:my-aurora-serverless-zaF524"
  s3_bucket_arn = "arn:aws:s3:::bedrock-kb-522529622052"
}